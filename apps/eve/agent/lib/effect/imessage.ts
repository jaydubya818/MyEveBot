    ...
    return {
      ...
      beginPair: (input) =>
        Effect.gen(function* () {
          ...
          yield* sendText(
            { handle },
            `Sofie here. Your pairing code is ${code}. It expires in 10 minutes. If you didn't ask to pair this number, ignore this text.`,
          ).pipe(
            Effect.tapError(() =>
              database
      ...
      verifyPair: (input) =>
        Effect.gen(function* () {
          ...
          // Sofie shows up in Messages with a name and photo they can save.
