...
export const AGENTCARD_TERMS_VERSION = "sofie-agentcard-2026-07-29-v2";
...
export function describeAgentcardError(error: AgentcardError): string {
  ...
  switch (error.reason) {
    ...
    case "consent_required":
      return "Agentcard cannot be connected until the owner explicitly authorizes Sofie and accepts the applicable Agentcard and card issuer terms.";
    case "provider":
