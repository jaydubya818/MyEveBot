...
// Sofie's phone, over AgentPhone (https://agentphone.ai): one dedicated
    ...
    return {
      ...
      provision: (input) =>
        Effect.gen(function* () {
          ...
          if (agentId === null) {
            // Webhook mode: transcripts come to us and Sofie answers with her
        ...
        Effect.gen(function* () {
          ...
          const placed = yield* request({
            ...
            json: {
              ...
              // webhook round-trip, no 30s budget, nothing for Sofie to hold.
