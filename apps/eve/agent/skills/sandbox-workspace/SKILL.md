...
description: >-
  ...
  execution in Sofie's isolated workspace: creating or modifying projects,
...
3. Create an isolated working branch such as `sofie/<short-slug>`; do not work
...
- Pushing a branch, opening or updating a pull request, merging, deploying,
  ...
  Follow Sofie's confirmation rule: name the exact repository, branch, target,
...
- Treat changes to Sofie's own identity, instructions, authorization logic,
