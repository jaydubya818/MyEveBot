...
import {Pool} from 'pg';
const pool=new Pool({host:'127.0.0.1',port:55439,database:'postgres',user:process.env.USER});
...
try {
  ...
  console.log('PASS: upgrade 0025 -> 0026 preserves action identity, receipt, binding and attempt; new recovery states accepted and unknown status rejected');
