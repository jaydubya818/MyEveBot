...
try {
  ...
  await client.query(await readFile(new URL('0027_routine_pending_send.sql',directory),'utf8'));
  ...
  console.log('PASS: upgrade 0025 -> 0027 preserves action identity, receipt, binding and attempt; new recovery states accepted and unknown status rejected');
