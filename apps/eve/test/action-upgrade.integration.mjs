...
try {
  ...
  await client.query(await readFile(new URL('0030_action_binding_reconciliation.sql',directory),'utf8'));
  ...
  console.log('PASS: upgrade 0025 -> 0030 preserves action identity, receipt, binding and attempt; new recovery states accepted and unknown status rejected');
