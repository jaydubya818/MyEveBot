...
type MainView = "chat" | "manage" | "goals" | "review" | "agents" | "knowledge";
...
function ChatApp({ initialView }: { initialView: MainView }) {
  ...
  function showView(next: MainView) {
    setView(next);
    const path = next === "manage" ? "/manage" : next === "agents" ? "/agents" : next === "goals" ? "/goals" : next === "review" ? "/review" : next === "knowledge" ? "/knowledge" : "/";
