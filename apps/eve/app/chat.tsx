    ...
    <div className="flex h-dvh w-full">
      ...
      {view === "agents" ? (
        <main className="relative h-dvh min-w-0 flex-1 overflow-y-auto">
          ...
          <div className="w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8"><AgentsPanel onStartChat={startAgentChat} onUseRole={useRole} /></div>
        </main>
      ) : view === "review" ? (
        <main className="relative h-dvh min-w-0 flex-1 overflow-y-auto">
          <Button
        ...
        <main className="relative h-dvh min-w-0 flex-1 overflow-y-auto">
          ...
          <div className="w-full max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <ManagePanel onOpenThread={selectThread} onStartAgentChat={startAgentChat} onUseRole={useRole} />
          </div>
        </main>
