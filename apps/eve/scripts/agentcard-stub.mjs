...
// in this stand-in only so older local checkouts can still boot; Sofie never
  ...
  if (path.startsWith("/attach/")) {
    ...
    if (method === "POST") {
      ...
      const page = `<!doctype html><meta charset="utf-8"><body style="font:16px system-ui;padding:40px">
        ...
        <p>Return to Sofie and say you finished so she can check the attachment.</p></body>`;
