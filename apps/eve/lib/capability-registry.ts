...
export const CAPABILITY_DEFINITIONS: readonly CapabilityDefinition[] = [
  ...
  tool("list_solution_packs", { description: "List curated outcome-oriented compositions of existing Role Packs and platform primitives. Recommendations do not grant authority.", permissions: ["agents.read"], keywords: ["solution pack", "founder", "operating system", "roles", "capabilities"] }),
