...
export const CAPABILITY_DEFINITIONS: readonly CapabilityDefinition[] = [
  ...
  tool("computer", { description: "Operate the configured persistent cloud desktop for bounded tasks.", feature: "integrations", permissions: ["computer.execute"], risk: "high", riskCategories: ["external-side-effect", "credential-boundary"], approval: "owner_policy", configuration: ["ORGO_API_KEY or DATABASE_URL"], evidence: { supported: true, types: ["screenshot", "log"] }, keywords: ["computer", "desktop", "browser", "task"] }),
