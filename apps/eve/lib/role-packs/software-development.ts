...
const PRODUCT_MANAGER_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Product objective", "User evidence", "Delivery constraints"],
  typicalOutputs: ["Delivery brief", "Acceptance criteria", "Prioritized scope"],
...
const DESIGNER_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["User need", "Product brief", "Existing interface patterns"],
  typicalOutputs: ["User flow", "Interaction specification", "State requirements"],
...
const ARCHITECT_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Delivery brief", "Repository constraints", "Existing architecture"],
  typicalOutputs: ["Technical design", "Integration contracts", "Risk plan"],
...
const DEVELOPER_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Technical design", "Acceptance criteria", "Write scope"],
  typicalOutputs: ["Implementation", "Focused tests", "Change summary"],
...
const TEST_AUTOMATION_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Acceptance criteria", "Critical flows", "Test environment"],
  typicalOutputs: ["Automated tests", "Fixtures", "Regression evidence"],
...
const CODE_SECURITY_REVIEWER_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Implementation diff", "Threat boundaries", "Acceptance criteria"],
  typicalOutputs: ["Prioritized findings", "Risk assessment", "Approval blockers"],
...
const RELEASE_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Release candidate", "Deployment environment", "Operational constraints"],
  typicalOutputs: ["Release checklist", "Rollback plan", "Health evidence"],
...
const SUPPORT_ROLE: RoleDefinition = {
  ...
  typicalInputs: ["Issue report", "Logs", "Affected user context"],
  typicalOutputs: ["Reproduction", "Triage assessment", "Response draft"],
