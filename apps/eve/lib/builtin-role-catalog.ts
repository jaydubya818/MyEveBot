...
import { FOUNDER_OS_ROLE_PACK, FOUNDER_OS_SOLUTION_PACK } from "./role-packs/founder-os.ts";
...
import { validateSolutionPacks } from "./solution-pack.ts";
...
validateSolutionPacks(BUILTIN_ROLE_CATALOG, BUILTIN_SOLUTION_PACKS);
